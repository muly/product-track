Feature:web scraping
    ...
    Given the deployed api host "https://smuly-test-ground.ue.r.appspot.com"
    ...
    | test amazon product availability    | /mock/amazon_available.html     | post        | /product  | amazon_available_product_response.json    | 200                           |
